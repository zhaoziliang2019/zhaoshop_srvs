...
class ProtoGenerator:
    ...
    def generate(self):
        with cd(self.python_dir):
            ...
            subprocess.call("workon zhaoshop_srv", shell=True)
            for file in files:
...
if __name__ == "__main__":
    # goods的proto生成
    # python_dir = "D:\\code\\pythonproject\\zhaoshop_srvs\\goods_srv\\proto"
    # go_dir = "D:\\code\\goproject\\src\\zhaoshop-api\\goods-web\\proto"
    # #
    # # #将py目录下的文件夹拷贝到go目录下
    ...
    py_gen = PyProtoGenerator(
        "D:\\code\\pythonproject\\zhaoshop_srvs\\inventory_srv\\proto"
    )
    py_gen.generate()
