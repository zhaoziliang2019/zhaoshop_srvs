...
def open_tracing_server_interceptor(tracer, log_payloads=False, span_decorator=None):
    ...
    return _server.OpenTracingServerInterceptor(tracer, log_payloads, span_decorator)
